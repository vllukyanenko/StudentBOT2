...
// create lists for days of week;
    ...
    public void setSchedule() {
        ...
        wednesday.add(new Lesson(" Алгоритмизация ", " 2.123 ", " Головко А.В; ", "08:00", "09:20"));
        wednesday.add(new Lesson(" Телекомуникации ", " 1.219 ", " Лисечко В.П; ", "09:30", "10:50"));
        wednesday.add(new Lesson(" Теория надежности систем автоматики ", " 221 ", " Кустов В.Ф; ", "11:00", "12:20"));

        thursday.add(new Lesson(" Психология ", " 223 ", " Колесников К.Э ; ", "08:00", "09:20"));
        thursday.add(new Lesson(" ТАУ ", " 225 ", " Хисматулин В.Ш ; ", "09:30", "10:50"));
        thursday.add(new Lesson(" Теория надежности систем автоматики ", " 221 ", " Кустов В.Ф; ", "11:00", "12:20"));
